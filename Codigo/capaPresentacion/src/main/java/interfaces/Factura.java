...
public class Factura extends javax.swing.JFrame {
    private JTextField txtNombreCliente, txtIdCliente;
    private JTable tablaProductos;
    private JTextArea txtFacturaGenerada;
    private JButton btnAgregarProducto, btnGenerarFactura;
    ...
    public Factura() {
        ...
        panelCliente.add(new JLabel("ID del cliente: "));
        txtIdCliente = new JTextField(20);
        panelCliente.add(txtIdCliente);
        add(panelCliente, BorderLayout.NORTH);
        
        
        String[] columnas = {"Productos", "Cantidad", "Precio Unitario", "SubTotal"};
        modeloTabla = new DefaultTableModel(columnas, 0);
        tablaProductos = new JTable(modeloTabla);
        add(new JScrollPane(tablaProductos), BorderLayout.CENTER);
        
        JPanel panelBotones = new JPanel();
        btnAgregarProducto = new JButton("AgregarProducto");
