 ...
 */
public class MetodoEfectivoDTO extends MetodoPagoDTO {
     ...
     */
    public MetodoEfectivoDTO(double efectivoEntregado, double cambio) {
     ...
     * @param cambio Cambio de la venta
     */
    public MetodoEfectivoDTO(int idPago, double total, double efectivoEntregado, double cambio) {
        super(idPago, total);
        this.efectivoEntregado = efectivoEntregado;
        this.cambio = cambio;
    }
