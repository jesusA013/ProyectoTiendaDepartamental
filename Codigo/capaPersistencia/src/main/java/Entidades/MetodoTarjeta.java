 ...
 */
public class MetodoTarjeta extends MetodoPago {
     ...
     */
    public MetodoTarjeta(String tarjeta, int mes, int ano, int cvc) {
     ...
     * @param cvc CVC de la tarjeta
     */
    public MetodoTarjeta(int idPago, double total, String tarjeta, int mes, int ano, int cvc) {
        super(idPago, total);
        this.tarjeta = tarjeta;
        this.mes = mes;
        this.ano = ano;
