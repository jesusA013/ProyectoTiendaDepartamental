...
public class Factura {
     ...
     * @param pais
     */
    public Factura(String folioFactura, Date fechaEmision, String rfc, String pais) {
    ...
    public String toString() {
        return "Factura{" + "folioFactura=" + folioFactura + ", fechaEmision=" + fechaEmision + ", rfc=" + rfc + ", nombreRazon=" + nombreRazon + ", calle=" + calle + ", numExt=" + numExt + ", numInt=" + numInt + ", colonia=" + colonia + ", codigoPostal=" + codigoPostal + ", delegacionMunicipio=" + delegacionMunicipio + ", ciudadLocalidad=" + ciudadLocalidad + ", estado=" + estado + ", pais=" + pais + ", correo=" + correo + '}';
    }
}
